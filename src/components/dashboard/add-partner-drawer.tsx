  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-[500px] border-l border-border p-0 flex flex-col overflow-hidden bg-background">
        <SheetHeader className="p-6 pb-4 sm:p-10 sm:pb-6 flex-row justify-start items-center space-y-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6 sm:px-10 sm:pb-10 flex flex-col gap-8 sm:gap-10">
          ...
          <form id="add-partner-form" onSubmit={handleSubmit(onSubmit)} className="mt-2 flex flex-col gap-6 sm:mt-4 sm:gap-8">
            {error && (
          ...
          <div className="border border-primary/20 bg-primary/5 p-6 sm:p-8 flex flex-col gap-6 relative overflow-hidden">
