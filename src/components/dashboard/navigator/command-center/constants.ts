...
export const CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: 'manage-vendor-documents', label: 'Manage Documents', shortcut: '4', icon: BriefcaseBusiness },
      { id: 'archive-vendor', label: 'Archive/Restore Vendor', shortcut: '5', icon: Hammer },
    ],
  },
  {
