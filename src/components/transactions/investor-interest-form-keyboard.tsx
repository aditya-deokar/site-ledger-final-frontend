...
type InvestorInterestInput = z.infer<typeof investorInterestSchema>;

interface InvestorInterestFormKeyboardProps {
  onSubmit: (data: InvestorInterestInput) => void;
  isPending?: boolean;
  error?: string | null;
  success?: boolean;
  onReset?: () => void;
...
export function InvestorInterestFormKeyboard({ 
  onSubmit, 
  isPending, 
  error, 
  success, 
...
}: InvestorInterestFormKeyboardProps) {
  ...
  const form = useForm<InvestorInterestInput>({
  ...
  const handleSubmit = (data: InvestorInterestInput) => {
    onSubmit(data);
  };
    ...
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
      ...
      {success && (
        <Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/20">
          ...
          <AlertDescription className="text-green-800 dark:text-green-200">
            Investor interest payment recorded successfully!
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  filteredInvestors.map((investor, index) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-muted-foreground">
                        ...
                        {investor.interestRate && ` Rate: ${investor.interestRate}%`}
                      </div>
                    </div>
                  ))
                ) : (
        ...
        <div className="space-y-2">
          ...
          />
          {selectedInvestor && selectedInvestor.interestRate && selectedInvestor.currentBalance && (
            <p className="text-sm text-muted-foreground">
              Rate: {selectedInvestor.interestRate}% | Balance: Rs. {selectedInvestor.currentBalance.toLocaleString('en-IN')}
            </p>
          )}
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <textarea
            id="note"
            placeholder="Add any additional details about this interest payment..."
            {...form.register('note')}
            ref={noteInputRef}
            rows={3}
        ...
        <Card className="bg-muted/30">
          <CardContent className="p-4">
            <div className="text-sm">
              ...
              {selectedInvestor.interestRate && ` | Interest Rate: ${selectedInvestor.interestRate}%`}
            </div>
          </CardContent>
        </Card>
      )}
      ...
      <TransactionFormFooter
        ...
        saveLabel="Pay Interest [Ctrl+Enter]"
      />
    </form>
  );
}
