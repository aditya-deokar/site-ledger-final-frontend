...
// Form schema
const investorPrincipalOutSchema = z.object({
...
type InvestorPrincipalOutInput = z.infer<typeof investorPrincipalOutSchema>;

interface InvestorPrincipalOutFormKeyboardProps {
  onSubmit: (data: InvestorPrincipalOutInput) => void;
  isPending?: boolean;
  error?: string | null;
  success?: boolean;
  onReset?: () => void;
...
export function InvestorPrincipalOutFormKeyboard({ 
  onSubmit, 
  isPending, 
  error, 
  success, 
...
}: InvestorPrincipalOutFormKeyboardProps) {
  ...
  const form = useForm<InvestorPrincipalOutInput>({
    resolver: zodResolver(investorPrincipalOutSchema),
    defaultValues: {
      amount: 0,
  ...
  const handleSubmit = (data: InvestorPrincipalOutInput) => {
    onSubmit(data);
  };
    ...
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
      ...
      {success && (
        <Alert className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/20">
          ...
          <AlertDescription className="text-green-800 dark:text-green-200">
            Investor principal return recorded successfully!
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  filteredInvestors.map((investor, index) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-muted-foreground">
                        ...
                        {investor.totalReturned && ` Returned: Rs. ${investor.totalReturned.toLocaleString('en-IN')}`}
        ...
        <div className="space-y-2">
          ...
          />
          {selectedInvestor && selectedInvestor.currentBalance && (
            <p className="text-sm text-muted-foreground">
              Available Balance: Rs. {selectedInvestor.currentBalance.toLocaleString('en-IN')}
            </p>
          )}
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <textarea
            id="note"
            placeholder="Add any additional details about this principal return..."
            {...form.register('note')}
            ref={noteInputRef}
            rows={3}
        ...
        <Card className="bg-muted/30">
          <CardContent className="p-4">
            <div className="text-sm">
              ...
              {selectedInvestor.totalReturned && ` | Total Returned: Rs. ${selectedInvestor.totalReturned.toLocaleString('en-IN')}`}
