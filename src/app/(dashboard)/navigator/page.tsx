      ...
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="space-y-3 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            {companyMissing ? 'Redirecting to company setup...' : 'Loading Navigator...'}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-6">
        <div className="max-w-md space-y-3 border border-border bg-card p-6 text-center">
          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground/60">Navigator Unavailable</p>
